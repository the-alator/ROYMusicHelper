...
describe("SourceResponseAccumulator spec", function () {
    ...
    beforeEach(function () {
        ...
        songProcessor = {processSong : sinon.stub().returns(true)};
    ...
    it("should delete unsuccessful download urls with MAX similarity", async function () {
        const maxSimilaritySong = {similarity: 1};
    ...
    it("should wait all responses and choose best match", async function () {
        ...
        await sourceResponseProcessor.success([{similarity : 0.4}], SOURCE);
